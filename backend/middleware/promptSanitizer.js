 ...
 * request reaches the controller. Runs AFTER llmPromptValidation (so prompt is
 * guaranteed to be a non-empty string within length limits).
 *
 * - Mutates req.body.prompt in place with the sanitized value.
 ...
 * - Never blocks the request — malicious patterns are stripped, not rejected.
 */
